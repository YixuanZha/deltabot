...
private:
    ...
    float proportional_gain = 3.0f; // Proportional gain for the controller
    float derivative_gain = 0.6f;   // Derivative gain for the controller
    float heading_gain = 1.5f;      // Heading gain for the controller
    float integral_gain = 0.07f;    // Integral gain for the controller
};
